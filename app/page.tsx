  ...
  themeImages: [
    {
      ...
      alt: "Innocence - Two children playing in water",
      theme: "Innocence",
      credit: "Life in Instalments",
    },
    {
      src: "/images/consequences.jpg",
      alt: "Consequences - Children sitting against a wall in distress",
      theme: "Consequences",
      credit: "Life in Instalments",
    },
    {
      src: "/images/hope.jpg",
      alt: "Hope - Children running on a beach at sunset",
      theme: "Hope",
      credit: "Life in Instalments",
    },
    {
      src: "/images/redemption.jpg",
      alt: "Redemption - Hands gripping a rope, symbolizing connection and struggle",
      theme: "Redemption",
      credit: "Life in Instalments",
    },
  ],

  // Static purchase links
  purchaseLinks: [
    {
      id: "1",
      name: "Amazon",
        ...
        <div className="container mx-auto px-4 z-10 relative">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="theme-grid grid grid-cols-2 gap-4">
              {STATIC_DATA.themeImages.map((image, index) => (
                <ThemeImage key={index} src={image.src} alt={image.alt} theme={image.theme} credit={image.credit} />
              ))}
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 z-10 relative">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="purchase-grid grid grid-cols-1 md:grid-cols-3 gap-8">
              {STATIC_DATA.purchaseLinks.map((link) => (
                <div
                  key={link.id}
      ...
      <section id="blog" ref={blogRef} className="py-24 bg-gray-950 relative">
        ...
        <div className="container mx-auto px-4 z-10 relative">
          ...
          <div className="blog-grid grid md:grid-cols-3 gap-8">
            {STATIC_DATA.blogPosts.map((post) => (
              <div
                key={post.id}
